...
import { Camera, Languages, Brain, Zap, Globe, Shield, Cpu, Wifi, Play, Settings, BarChart3, Users, Smile } from 'lucide-react';
import { DIGITAL_CERTIFICATE, SUPPORTED_LANGUAGES, ADVANCED_AI_MODELS, THEME_COLORS } from '@/constants';
import { SignLanguage, UserSettings, AnalyticsData, PerformanceMetrics } from '@/types';
