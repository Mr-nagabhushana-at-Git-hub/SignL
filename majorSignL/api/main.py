...
from majorSignL.utils.mediapipe_processor import MediaPipeProcessor
...
from majorSignL.models.sign_classifier import SignClassifier
from majorSignL.models.gender_processor import GenderProcessor
from majorSignL.config import MODELS_DIR, SIGN_LANGUAGE_MODEL, FRONTEND_DIR
from majorSignL.api.websocket_handler import WebSocketManager, websocket_endpoint
...
async def debug_face_paths():
    ...
    from majorSignL.config import FACE_DATA_DIR, PROJECT_ROOT
